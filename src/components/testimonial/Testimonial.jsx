                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://media.licdn.com/dms/image/v2/D5603AQFezQgvmr0nXQ/profile-displayphoto-shrink_200_200/B56ZZDZFBJGUAg-/0/1744887371371?e=2147483647&v=beta&t=Q-BwScXroGi3SmD-OF1A6VBYxmwuCZIjd1vk1CRLbfM" />
                                ...
                                <h2 style={{color: mode === 'dark' ? '#41b32bff' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Khushi Ganesh Palankar</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p  style={{color: mode === 'dark' ? 'white' : ''}}className="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-600 mt-6 mb-4" />
                                <h2 style={{color: mode === 'dark' ? '#41b32bff' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">React Js</h2>
