    ...
    return (
        <div>
            <div className=' flex justify-center items-center h-screen'>
                <div className=' bg-gray-600 px-10 py-10 rounded-xl '>
                    <div className="">
                    ...
                    <div>
                        ...
                        onChange={(e) => setProducts({ ...products, title: e.target.value })} value={products.title}
                            name='title'
                            className=' bg-green-300 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-black placeholder:text-black-200 outline-none'
